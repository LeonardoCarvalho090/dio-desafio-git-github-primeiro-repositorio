...
programa
{
	...
	{	//Declarei as variaveis abaixo
		...
		escreva("Digite tabuada que deseja visualizar ")
		//Le o numero digitado
		leia(numero)
		//Defini o valor de contador para 1
		contador = 1
		//Defini o valor de limite selecionado pelo usuario
		escreva("Digite até que número deseja visualizar a tabuada selecionada ")
		//le o numero digitado
		leia(limite)
		//Iniciei o looping
		faca
